				...
				<div className="container">
					<div className="order-hitory">
						...
						<div className="paragraph-text-block">
							...
							<p>CGT is dedicated to providing college students with quick essentials delivered directly to their doorstep. It is our goal to bring students joy by supplying anything they need within 15 minutes while connecting with other college students in the community.</p>
							<p>Our CGT family fosters a positive, uplifting environment where everyone’s perspectives are heard. We encourage and empower each other to bring innovative ideas to the table and are constantly welcoming suggestions and improvements. As students, we aim to ensure that our fellow students feel special and satisfied with our quick delivery service.</p>
						...
						<div className="row align-items-center">
							...
							<div className="col-xl-6 col-lg-6 col-md-6 col-sm-12">
								<div className="heading-paragraph-design">
									...
									<p>As a CGT Rider, you'll have the opportunities to create a flexible schedule, bond with fellow students, and earn paychecks for riding around really fast! What's not to love?</p>
