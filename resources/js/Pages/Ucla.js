																						   ...
																						   <div className="products">
																							   ...
																							   <div className="add-to-cart">
																								   ...
																								   {(storeHours && product.qty>0) &&
																									   <span onClick={() => addToCart(product.id,product.store_id)}>
			...
			<div id="product-popup" className="active">
				<div className="product-popup-inner-wrapper">
					...
					<div className="product-popup-cntnt">
						...
						<button className="cart-btn pink-btn-design" onClick={() => addToCart(productPopup.id,productPopup.store_id)}>Add To Cart</button>
						}
						{productPopup.qty==0 &&
							<span className="out-stock">Out of Stock</span>
						}
