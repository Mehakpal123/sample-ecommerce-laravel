...
class ProductsController extends Controller
{
    ...
    public function index(Request $request){
		...
		return view('admin.products.index', compact('title', 'products', 'category'));
	}
    ...
    public function create(){
		...
		$stores = User::Where('role', 'store')->where('status','1')->pluck('name', 'id');
		$category = Category::where('status', '1')->where('is_delete', '0')->orderBy('id', 'desc')->pluck('name', 'id');
		return view('admin.products.create', compact('title','category','stores'));
	}
	...
	public function edit(Request $request, Products $product)
    {
		...
		$category = Category::where('status', '1')->where('is_delete', '0')->orderBy('id', 'desc')->pluck('name', 'id');
		return view('admin.products.edit', compact('title', 'product', 'category','stores'));
    }
