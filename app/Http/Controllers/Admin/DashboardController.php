...
class DashboardController extends Controller
{
    ...
    public function index(){
		...
		return view('store.dashboard.index', compact('title', 'newOrder', 'dailyOrder', 'totalOrders', 'dailyCancleOrder', 'sales', 'dailySales', 'latestUser', 'products', 'dailyUser', 'settings'));
	}
}
